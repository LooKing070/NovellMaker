...
Здесь вы не пишете код - вы пишите историю.

**NovellMaker** — a game engine for creating games of the "visual novel" genre, which requires the developer to have only basic skills in using the file system.
You're not writing code here, you're writing a story.